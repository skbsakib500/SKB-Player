...
/**
 * Simple Result-based API used by FolderScreen (non-consent paths).
 * For API 30+ consent flow the UI handles MediaStore.createDeleteRequest/createWriteRequest directly.
 */
object FileOps {
